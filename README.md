...
* **Prescriptive Logic**: A novel recommendation layer that maps XAI "Reason Codes" to specific business retention strategies.
...
* **Libraries**: `xgboost`, `scikit-learn`, `imblearn` (SMOTEENN), `shap`, `lime`, `pandas`
...
## 📖 Key Reference
* **Base Paper**: Güllü, M., Dede, R., & Duru, İ. (2025). *Telecom Customer Churn Prediction: In-Depth Analysis with Artificial Intelligence Algorithms and Explainable Artificial Intelligence.*
